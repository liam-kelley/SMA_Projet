...
def run_single_server(grid_size, num_gamers_per_team):
    ...
    server = mesa.visualization.ModularServer(
        ...
        {"num_gamers_per_team": num_gamers_per_team, "width": grid_size[0], "height": grid_size[1]} # Model parameters
    )
    server.port = 8521  # The default
    server.launch()

if __name__ == "__main__":
    run_single_server(grid_size = [7,7], num_gamers_per_team=3)